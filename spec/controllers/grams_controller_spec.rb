...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    ...
    it "shouldn't let unauthenicated users to destroy a gram" do 
      gram = FactoryBot.create(:gram)
      delete :destroy, params: { id: gram.id }
  ...
  describe "grams#update" do 
    ...
    it "should successfully allow for users to update their gram" do 
  ...
  describe "grams#edit" do 
    ...
    it "should not let unauthenicated users to edit a gram" do 
      gram = FactoryBot.create(:gram)
      get :edit, params: { id: gram.id }
      expect(response).to redirect_to new_user_session_path
    end

    it "should successfully allow for the user to edit the page if the gram is found" do 
      gram = FactoryBot.create(:gram)
      sign_in gram.user
      get :edit, params: { id: gram.id }
    ...
    it "should return a 404 error message if the gram is not found in the database" do 
      user = FactoryBot.create(:user)
      sign_in user 
